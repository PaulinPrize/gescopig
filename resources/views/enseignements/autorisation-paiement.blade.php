                ...
                <div class="box-body">
                    ...
                    <div class="row" style="margin:5px">
                        <div class="col-lg-12">
                            ...
                            <h4 class="text-center" style="color:#000000">PARTIE RESERVEE A LA DIRECTION ADMINISTRATIVE</h4>
                            <div class="row">
                                <div class="col-lg-12">
                                    <table class="table table-striped table-bordered">
                                        <thead class="thead-dark">
                                            <tr>
                                                ...
                                                <th class="text-center">Signature CC</th>
                                                <th class="text-center">Signature SG</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="text-center">RAT (5.5%)</td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
